...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * Determines if request should be filtered
     * @param request Current HTTP request
     * @return true if path is excluded from filtering
     */
    @Override
    ...
    protected void doFilterInternal(
        ...
        // Skip authentication if no JWT token present
        ...
        // Process authentication only if user not already authenticated
